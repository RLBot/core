...
namespace Bridge.Conversion
{
    internal class ColorSwatches
    {
        ...
        {
            var swatches = team == 0 ? _blueSwatches : _orangeSwatches;
        ...
        {
            var swatches = _secondarySwatches;
            return Color.FromArgb(255, swatches[colorId, 0], swatches[colorId, 1], swatches[colorId, 2]);
        }
        ...
        private static int[,] _blueSwatches = new int[70, 3]
        {
            { 80, 127, 57 },
            { 57, 127, 63 },
            { 57, 127, 100 },
        ...
        private static int[,] _orangeSwatches = new int[70, 3]
        {
            { 127, 127, 57 },
            { 127, 112, 57 },
            { 127, 99, 57 },
        ...
        private static int[,] _secondarySwatches = new int[105, 3]
        {
            { 229, 229, 229 },
            { 255, 127, 127 },
            { 255, 159, 127 },
