...
internal static class ColorSwatches
{
    ...
    internal static Color GetSecondary(uint colorId) => Color.FromArgb(
        255, 
        SecondarySwatches[colorId, 0],
        SecondarySwatches[colorId, 1], 
        SecondarySwatches[colorId, 2]
    );
    ...
    private static readonly int[,] BlueSwatches = {
        { 80, 127, 57 },
        { 57, 127, 63 },
        { 57, 127, 100 },
        { 57, 125, 127 },
